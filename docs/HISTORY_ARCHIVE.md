# History Archive (pre-2026-04)

Older changelog entries split out from `docs/HISTORY.md` on 2026-04-15
to keep the active history file readable. The active `HISTORY.md`
contains entries from 2026-04-01 onward; older entries are preserved
verbatim below in reverse-chronological order. No content was modified
during the split — the cut is purely line-based at the
`## 2026-03-27` heading.

When adding new entries, write them to `docs/HISTORY.md`. Move entries
into this archive only when `HISTORY.md` becomes unwieldy again (the
2026-04-15 split happened at ~4400 lines).
