...
**Current status:** All work reverted. Branch is back to base state. Work needs to be redone by fetching the specs from gp-props `docs/implementations/` (see CLAUDE.md > Suggested Implementations for how) and following the TODO step by step.
