...
- `reports/*/metadata.json` - Repo metadata (small, useful)
...
**What gets cleaned up automatically (after repo fully processed):**
- `reports/*/commits.json` - Redundant (data is in processed/)
- `reports/*/data.json` - Redundant (data is in processed/)
- `reports/*/files.json` - Redundant
- `reports/*/contributors.json` - Redundant
- `reports/*/summary.json` - Redundant
- `pending/<repo>/` - No longer needed
