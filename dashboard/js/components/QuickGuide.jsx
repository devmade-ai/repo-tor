...
const STEPS = [
    ...
    },
    {
        ...
        body: 'Use the tabs at the top to switch between views. Summary gives you the highlights, Timeline shows trends, Breakdown has detailed numbers, Health flags potential issues, and Discover reveals fun insights. To browse all our projects, open the menu in the top-right corner and choose "View all projects".',
        icon: (
            <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
